...
/**
 * Servlet implementation class QueryRepairman
 */
@WebServlet("/admin/QueryRepairmanServlet")
public class QueryRepairmanServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryRepairmanServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalNum = 0; //总页数
		int totalcount = rdao.QueryRepairman1().size();  //总记录数
		...
		ArrayList list = rdao.QueryRepairman(begin-1, count);//传入  数据库记录的起始位置
		...
		response.sendRedirect("repairmanview.jsp");
	}
